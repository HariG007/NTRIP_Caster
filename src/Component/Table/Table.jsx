  ...
  return (
    <>
      <div>
        <center>
          <div>
            <table className="table mb-0" style={{ border: '2px solid lightgray', borderRadius: '20px',  boxShadow: 'rgba(149,157,165,0.2) 0px 8px 24px',width:'90%',textAlign:'center',backgroundColor:'white',height:'300px' }}>
              <thead>
                <tr>
